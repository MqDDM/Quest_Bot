    ...
    stages = [
        ...
        Stage(
            ...
            description="Подойдя ещё чуть ближе, вы почувствовали, как флешка начала нагреваться. Ан "
                        ...
                        "размеренной жизнью пространства. Оно являлось отличной перспективой для создания чего-то нового, "
                        "такого же чисто-го, как и окружение.",
            choices=[
        ...
        Stage(
            ...
            description="В точно такой же комнате тоже стояли манекены. Только не по одиночке. Их было двое.\n"
                        ...
                        "Второй манекен был ненамного выше. В нём читалась женская фигура. В отличие от вашей "
        ...
        Stage(
            ...
            description="Ан покачала головой.\n"
                        ...
                        "В тёмном свете очков вся комната выглядела странно, но так живо. Она наполнялась иллюзиями декора, может когда-то находившегося здесь. Но вскоре это начало надоедать.\n"
        ...
        Stage(
            ...
            description="Там была точно такая же комната, но вместо одного манекена, были два. Один был ростом "
                        "с вас, так же напоминая внешность этого тела. Чёрные, длинные пряди волос, одежда, сильно "
        ...
        Stage(
            ...
            description="*Концовка #4 - \"Домашний любимец\"*\n"
                        "Ан стала единым с Тьмой посредством домашней чёрной дыры. Постепенно вы начали\nтерять "
        ...
        Stage(
            ...
            description="Ваше молчание отдалось эхом в голове.\nЭто почувствовали не только вы.\nТело вытянулось и "
                        ...
                        "мне?\nДевушка застыла, будто ожидая вашего знака, но не вытерпев столь долгого и "
                        ...
                        "- потом слова прозвучали немного разочаровано, даже с неким уютом, подтверждающим, "
        ...
        Stage(
            ...
            description="Как и прошлая, эта дверь исчезла где-то в тумане. Стоит ли говорить, что Ан выдыхает с облегчением. Тревожность покидает ваш общий разум. Тело продолжает шагать вперёд.\n"
                        ...
                        "бела и пустынна. По бокам были две двери, а посередине стоял диван, а рядом круглый столик с ярко-красной розой в прозрачной вазе и ноутбуком.\n"
        ...
        Stage(
            ...
            description="Ан с размаху бьёт по двери. Слышится скрежет металла, затем оханье, но дверь не "
                        "открывается. Вы пробуете ещё и ещё. В конечном счёте вы разбиваете вдребезги биту.\n"
        ...
        Stage(
            ...
            description="- _Рада, что могу на тебя положиться_!\n" +
                        ...
                        check_condition_desc(user,
                                             ...
                                             ('inventory', 'Деревянная бита', '=', True)) +
                        check_condition_desc(user,
                                             "_Девушка натягивает очки на голову, но не стремится надеть их на нос. "
